		...
		<div class="row">
				<div class="col-md-5 col-sm-12 col-xs-12">
					<div class="product-image"> 
						<img src="{{url('/')}}/upload/{{$product->image}}" class="img-responsive"> 
						<span class="tag2 hot">
							HOT
						</span> 
					</div>
				...
				<div class="product-deatil">
                        ...
                        <strike><p class="price-container">
				...
				<div class="product-info smart-form">
					<div class="row">
						<div class="col-md-12"> 
                            ...
                            <a href="{{url('/single_product/'.$product->id)}}" class="btn btn-info">More info</a>
						</div>
						<div class="col-md-12">
